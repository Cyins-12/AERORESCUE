...
public class TeleportationSystem : MonoBehaviour
{
    ...
    public Transform SeatTeleport; // Titik teleportasi Tempat Duduk
    public GameObject teleportBackButton; // Tombol untuk teleport kembali ke ruangan teleportasi

    private float defaultScaleY = 1f; // Skala Y awal pemain
    private float teleportScaleY = 0.7f; // Skala Y saat teleportasi ke ruang kantor atau tes
    ...
    {
        StartCoroutine(TeleportWithFade(SeatTeleport, teleportScaleY, true));
    }
